...
class Cfg_Opts(object):
    def __init__(self,):
        ...
        self.Model_Set['Head_dict']   = {'heatmap':1, 'reg': 2, 'tag': 1}
...
if __name__ == "__main__":
    ...
    model.eval()
    model.cuda()
    model.load_param("work_space/DLA_34_2020-10-19-14-12-33/Epoch_best.pth")
    ...
    for key in VAL_DATA.keys():
        if('Synthetic' in key): 
            if('line' in key or 'scatter' in key):   ### line, scatter
                print(key)
                ...
                if('line' in key):
                    ...
                    json_data['task6']['output']['visual elements']['lines'] = result
                ...
                if('scatter' in key):
                    ...
                    json_data['task6']['output']['visual elements']['scatter points'] = result
